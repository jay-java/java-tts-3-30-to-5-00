...
%>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    ...
                                    <a href="customer-registration.jsp" class="dropdown-item">Manage Products</a>
                                </div>
                            </div>
                             <div class="nav-item dropdown">
	...
	<div class="container-fluid">
		<h2
			...
			<span class="bg-secondary pr-3">Seller Registration</span>
		</h2>
		<div class="row px-xl-5">
			<div class="col-lg-7 mb-5">
				<div class="contact-form bg-light p-30">
					...
					<form action="SellerController" name="sentMessage" method="post">
						<input type="hidden" class="form-control" id="name" name="id" value="<%=s.getId() %>"
						...
						<div class="control-group">
							<input type="text" class="form-control" id="subject" name="contact" value="<%=s.getContact() %>"
								data-validation-required-message="Please enter a subject" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="text" class="form-control" id="subject" name="address" value="<%=s.getAddress() %>"
								data-validation-required-message="Please enter a subject" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="update" id="sendMessageButton">Update
							</button>
						</div>
					</form>
				</div>
