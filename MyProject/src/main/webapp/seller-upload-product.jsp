...
<body>
		...
		<div class="row px-xl-5">
			<div class="col-lg-3 d-none d-lg-block">
				<nav
					...
					id="navbar-vertical"
					style="width: calc(100% - 30px); z-index: 999;"></nav>
			</div>
			<div class="col-lg-9">
				<nav
						...
						<div class="navbar-nav mr-auto py-0">
							...
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									data-toggle="dropdown">Products <i
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									...
									<a href="seller-change-password.jsp" class="dropdown-item">Change
										Password</a> <a href="seller-logout.jsp" class="dropdown-item">Logout</a>
								</div>
							</div>
						</div>
			...
			<div class="col-12">
				<nav class="breadcrumb bg-light mb-30">
					<a class="breadcrumb-item text-dark" href="#">Home</a> <span
						class="breadcrumb-item active">Seller</span>
				</nav>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		<h2
			...
			<span class="bg-secondary pr-3">Upload Product</span>
		</h2>
		<div class="row px-xl-5">
			<div class="col-lg-7 mb-5">
				<div class="contact-form bg-light p-30">
					<div id="success"></div>
					<form action="ProductController" name="sentMessage" method="post" enctype="multipart/form-data">
						<input type="hidden" class="form-control" id="name" name="sid" value="<%=s.getId()%>">
						...
						<div class="control-group">
							<input type="text" class="form-control" id="subject"
								name="pprice" placeholder="Product Price" required="required"
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="upload" id="sendMessageButton">Upload
							</button>
						</div>
					</form>
				</div>
