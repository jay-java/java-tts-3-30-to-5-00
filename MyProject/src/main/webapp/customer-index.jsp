                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                           ...
                           <!--  <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    ...
                                    <a href="seller-manage-product.jsp" class="dropdown-item">Manage Products</a>
                                </div>
                            </div> -->
                             <div class="nav-item dropdown">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="" class="btn px-0 ml-3">
                                ...
                                <%List<Cart> list1 = CartDao.getCartListByCusId(s.getId()); %>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;"><%out.print(list1.size()); %></span>
                            </a>
                        </div>
                    </div>
                </nav>
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="CartController?action=addtocart&pid=<%=p.getPid()%>&cusid=<%=s.getId()%>"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>Rs. <%=p.getPprice() %></h5><h6 class="text-muted ml-2"><del></del></h6>
                        </div>
                    </div>
                </div>
            </div>
