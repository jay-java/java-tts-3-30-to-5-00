...
<body>
	...
	<div class="container-fluid">
		<h2
			...
			<span class="bg-secondary pr-3">Seller Change Password</span>
		</h2>
		<div class="row px-xl-5">
			<div class="col-lg-7 mb-5">
				<div class="contact-form bg-light p-30">
					...
					<form action="SellerController" name="sentMessage" method="post">
						<input type="hidden" class="form-control" id="subject" name="id"
							value="<%=s.getId()%>"
							data-validation-required-message="Please enter a subject" />
						<div class="control-group">
							<input type="password" class="form-control" id="subject"
								name="op" placeholder="Old Password " required="required"
								data-validation-required-message="Please enter a subject" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="password" class="form-control" id="subject"
								name="np" placeholder="New Password " required="required"
								data-validation-required-message="Please enter a subject" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="change password" id="sendMessageButton">Change Password
							</button>
						</div>
					</form>
