						...
						<div class="navbar-nav mr-auto py-0">
							...
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									data-toggle="dropdown">Registration <i
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="seller-registration.jsp" class="dropdown-item">As
										Seller</a> <a href="customer-registration.jsp"
										class="dropdown-item">As Customer</a>
								</div>
							</div>
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									data-toggle="dropdown">Login <i
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="seller-login.jsp" class="dropdown-item">As Seller</a>
									<a href="customer-login.jsp" class="dropdown-item">As
					...
					<form action="SellerController" name="sentMessage" method="post">
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="register" id="sendMessageButton">Register
							</button>
						</div>
					</form>
				</div>
